...
|------|----------|----------|
| 👨‍💼 CISO | admin@kavachx.bank | password123 |
| 👤 Demo | demo | demo |
...
| Framework | Purpose |
|-----------|----------|
| RBI Cyber Security Framework (CSITE) | Mandates SOC establishment, incident monitoring, and reporting mechanisms |
| RBI Digital Payment Security Controls | Requires correlation of digital transactions with cyber anomalies |
| RBI Master Direction on IT Framework | Directs continuous risk assessment and access log monitoring |
